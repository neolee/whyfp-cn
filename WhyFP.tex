...
\begin{quotation}这篇论文最早写于1984年，之后在 Chalmers 大学流传了多年。稍微修订过一些的两个版本分别在1989和1990年发布（\cite[Hug89]{Hug89}和\cite[Hug90]{Hug90}）。下面这个版本以最早的 nroff 源文件为基础，遵循 \LaTeX 的习惯做了些修改以便更接近可出版的效果，同时也包含一两处小错误修正。各位对于老旧的排版，以及没有使用 Haskell 来编写样例代码可以尽情的抱怨！\end{quotation}
